...
const ChapterUi = ({ novelId, chapterKey, topicDetails }: ChapterUiProps) => {
    ...
    return (
        <div>
            <h1 className="p-2 flex gap-1 items-center font-medium border-b border-input">Topic Roadmap
                {topicDetails?.details && <FaEdit className="cursor-pointer" onClick={() => setOpenTopicsModal(true)} />}
            </h1>
                ...
                <DialogContent className="max-w-[85vw] bg-[#150F2D] text-white">
                    ...
                    <div className="">
                        ...
                        <div className="flex items-center justify-end gap-4">
                            <Button form="topic-form" type="submit" className="flex gap-1 items-center hover:bg-background hover:text-white" variant="outline" disabled={submitLoader}>
                                {submitLoader ? (
                                    <>
